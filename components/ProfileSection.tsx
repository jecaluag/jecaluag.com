  ...
  return (
    <section className='grid-item gap-5 md:gap-6 mb-10 items-center'>
      <div className='col-span-1'>
        <Image src={Pic} alt={profileDetails.name} className='!w-[30%] lg:!w-full rounded-full' />
      </div>
      <div className='col-span-3'>
        <h1 className='text-white text-xl'>{profileDetails.name}</h1>
        <p>{profileDetails.jobTitle}</p>
        <a href={profileDetails.emailLink} className='text-neutral-500 underline-offset-3 hover:underline'>
