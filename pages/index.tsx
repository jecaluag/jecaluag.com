...
const InlineImage = ({ image }: InlineImageProps): JSX.Element => (
  <div className='inline-image-wrapper'>
    <Image src={image} width="100%" height="100%" className="align-middle !relative !w-auto !h-9 lg:!h-[64px] !min-h-[auto]" />
  </div>
)
        ...
        <Container>
          <div className='h-full flex flex-col justify-center px-3 md:px-0'>
            ...
            <h1 className='w-full font-monument font-bold uppercase hero__headline leading-none text-[#042a2b]'> 
              ...
              <span className='overflow-hidden block -mt-1 lg:-mt-3'>Engineer</span>
        ...
        <Container zIndex={1}>
          <div className='h-full flex items-center justify-center'>
            <div className='max-w-4xl mix-blend-screen px-2 sm:px-0'>
              <h1 className='text-[24px] font-thin sm:text-2xl md:text-3xl lg:text-[32px] leading-[1.75] sm:leading-loose lg:!leading-[76px]'>
                IN THE <u>GAME</u> <InlineImage image={InlineImageOne} /> FOR OVER THREE YEARS I&apos;VE <i className='not-italic relative inline-block px-2  lg:px-3 highlighted'>DEVELOPED</i> A RANGE OF AMAZING <InlineImage image={InlineImageTwo} /> <u>WEB</u> AND <u>MOBILE</u> APPLICATIONS FOR COMPANIES AND SMALL BUSINESSES
              </h1>
            </div>
          </div>
        </Container>
